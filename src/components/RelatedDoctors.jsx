...
const navigate = useNavigate()
  ...
  return  <section className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
  <h1 className='text-3xl font-medium'>Related Doctors</h1>
  <p className='sm:w-1/3 text-center text-sm'>
    Our extensive list of related doctors.
  </p>

  <div className='w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
    {relDoctor.slice(0, 5).map((doctor, i) => (
      <div
        onClick={() => {navigate(`/appiontment/${doctor._id}`);scrollTo(0,0)}}
        key={i}
        className='border
